...
public class PropertyConfigurator implements Configurator {
  ...
  protected void configureLoggerFactory(Properties props) {
    ...
    if (factoryClassName != null) {
      ...
      loggerFactory = (LoggerFactory) OptionConverter.instantiateByClassName(factoryClassName, LoggerFactory.class,
          loggerFactory);
    ...
    while (enumeration.hasMoreElements()) {
      ...
      if (key.startsWith(CATEGORY_PREFIX) || key.startsWith(LOGGER_PREFIX)) {
        ...
        if (hierarchy instanceof ThrowableRendererSupport) {
          ThrowableRenderer tr = (ThrowableRenderer) OptionConverter.instantiateByKey(props, THROWABLE_RENDERER_PREFIX,
  ...
  Appender parseAppender(Properties props, String appenderName) {
    ...
    if (appender instanceof OptionHandler) {
      ...
      if (errorHandlerClass != null) {
        ErrorHandler eh = (ErrorHandler) OptionConverter.instantiateByKey(props, errorHandlerPrefix, ErrorHandler.class,
            null);
        if (eh != null) {
