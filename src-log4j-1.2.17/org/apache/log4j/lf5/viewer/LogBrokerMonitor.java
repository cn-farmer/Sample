...
//    public static final String COMPACT_VIEW = "Compact";
  ...
  protected JMenuItem createEditFindMI() {
    ...
    editFindMI.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        String inputValue = JOptionPane.showInputDialog(_logMonitorFrame, "Find text: ", "Search Record Messages",
...
//    }
  ...
  protected void closeAfterConfirm() {
    ...
    int value = JOptionPane.showConfirmDialog(_logMonitorFrame, message.toString(), title, JOptionPane.OK_CANCEL_OPTION,
